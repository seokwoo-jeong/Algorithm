...
import codingtest.Nhn202205.Nhn2_RE2;
...
//		Ssg2_re ssg2 = new Ssg2_re();
		...
		/*
		 * String[] logs = { "1901 1 100", "1901 2 100", "1901 4 100", "1901 7 100",
		 * "1901 8 100", "1902 2 100", "1902 1 100", "1902 7 100", "1902 4 100",
		 * "1902 8 100", "1903 8 100", "1903 7 100", "1903 4 100", "1903 2 100",
		 * "1903 1 100", "1101 1 95", "1101 2 100", "1101 4 100", "1101 7 100",
		 * "1101 9 100", "1102 1 95", "1102 2 100", "1102 4 100", "1102 7 100",
		 * "1102 9 100" };
		 */
